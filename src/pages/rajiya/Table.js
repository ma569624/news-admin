...
const Table = () => {
    ...
    const Delethandler = (id) => {
        ApiCalls(`rajiya/${id}`, 'DELETE').then((response) => {
            getdata()
            ...
            <section className="content">
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Rajiyo</h3>
                        <div class="card-tools">
                            <NavLink to={'/addrajiya'} className="btn bg-primary btn-sm px-2 py-1">
                                    ...
                                    bannerdata.map((item, key) =>
                                        <tr key={key}>
                                            ...
                                            <td className="project-actions text-right">
                                                ...
                                                <NavLink to={`/rajiya/${item._id}`} className="btn btn-info btn-sm">
