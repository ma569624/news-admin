...
const Table = ({categories}) => {
    ...
    const Delethandler = (id) => {
        ApiCalls(`categories/${id}`, 'DELETE').then((response) => {
            getdata()
                ...
                <div className="card">
                    <div className="card-header">
                        ...
                        <div class="card-tools">
                            <NavLink to={`/add-categories`} className="btn bg-primary btn-sm px-2 py-1">
                                    ...
                                    bannerdata.map((item, key) =>
                                        <tr key={key}>
                                            ...
                                            <td className="project-actions text-right">
                                                ...
                                                <NavLink to={`/edit-categories/${item._id}`} className="btn btn-info btn-sm">
