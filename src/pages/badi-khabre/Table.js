...
const Table = () => {
    ...
    const getdata = () => {
        ApiCalls('badikhabar').then((response) => {
    ...
    const Delethandler = (id) => {
        ApiCalls(`badikhabar/${id}`, 'DELETE').then((response) => {
            getdata()
            ...
            <section className="content">
                <div className="card">
                    <div className="card-header">
                        <h3 className="card-title">Badi khabar</h3>
                        <div class="card-tools">
                            <NavLink to={'/add-badi-khabar'} className="btn bg-primary btn-sm px-2 py-1">
                                    ...
                                    bannerdata.map((item, key) =>
                                        <tr key={key}>
                                            ...
                                            <td className="project-actions text-right">
                                                ...
                                                <NavLink to={`/edit-badi-khabar/${item._id}`} className="btn btn-info btn-sm">
