            ...
            <Row>
                <Col lg='12'>
                    ...
                    <form
                        ...
                        method="post"
                        action="./SaveShubhKamnasandeshLink"
                    >
                        <table
                            width={700}
                            height={780}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td height={23} className="Label">
                                        <div align="left">Image Fourth </div>
                                    </td>
                                    <td colSpan={2}>
                                        <div align="left">
                                            <input
                                ...
                                <tr>
                                    <td className="Label">
                                        <div align="left">Image Fourth Caption</div>
                                    </td>
                                    <td colSpan={2}>
                                        <div align="left">
                                            <input
